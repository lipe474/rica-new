...
export const CardHighlights = ({ Categories, image, published_at, resume, title }: CardArticle) => {
    return (
        <Box
            marginTop="2"
            display="flex"
