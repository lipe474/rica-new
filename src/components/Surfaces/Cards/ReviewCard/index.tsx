...
export default function ReviewCard({ id, title, resume, image, published_at, Categories }: CardArticle) {
    ...
    return (
        ...
        >
            <Link href={`/article/${id}?category_id=${Categories && Categories[0]?.category_id}`}>
                <Box
                    display="flex"
                    flexDirection="column"
